...
url(r'^add_ps_page$',views.add_ps_page,name='add_ps_page'),
...
url(r'^delete_ppoint/(.*)/$',views.delete_ppoint,name='delete_ppoint'),
...
url(r'^get_all_ps/$',views.get_all_ps,name='get_all_ps'),
url(r'^add_ps/$',views.add_ps,name='add_ps'),
